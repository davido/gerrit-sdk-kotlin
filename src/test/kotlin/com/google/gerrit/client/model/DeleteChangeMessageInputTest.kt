...
class DeleteChangeMessageInputTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of DeleteChangeMessageInput
        //val modelInstance = DeleteChangeMessageInput()
