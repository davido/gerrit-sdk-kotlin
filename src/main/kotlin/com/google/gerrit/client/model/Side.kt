...
enum class Side(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is Side) "$data" else null

        /**
         * Returns a valid [Side] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): Side? = data?.let {
